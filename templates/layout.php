...
<body class="<?php if ($hasOverlay): ?> overlay <?php endif; ?>">
            ...
            <section class="content__side">
                ...
                <nav class="main-navigation">
                    ...
                    <?php foreach ($categories as $category): ?>
                        <li class="main-navigation__list-item <?php if ($category['id'] == 0): ?> main-navigation__list-item--active <?php endif; ?>">
                            <a class="main-navigation__list-item-link" href="../index.php?project_id=<?=$category['id']; ?>"><?=$category['name']; ?></a>
                            <span class="main-navigation__list-item-count"><?=numOfTasks($tasks, $category['id']); ?></span>
                        </li>
                    <?php endforeach; ?>
                    </ul>
                </nav>
